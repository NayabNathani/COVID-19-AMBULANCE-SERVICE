...
int main()
{
	...
	while(1)
	{
	    ...
	    cout << "=============================================\n\n";
	    cout << "Enter 2 to Display All Patients (In Order).\n"; //Display the whole data set (ordered)
	    cout << "=======================================\n\n";
	    cout << "Enter 3 To Avail Ambulance Service.\n";       
	    cout << "=======================================\n\n";
	    cout << "Enter 4 To Search A Patient's Data.\n"; //searching a particular individual/maybe out of priority
	    cout << "=================================================================\n\n";
	    cout << "Enter 5 To Delete A Patient's Data.\n"; //incase the patient cures somehow
	    cout << "=======================================\n\n";
		...
		else if(choice == 3)
        {
            ...
            system("cls");
            cout<<"\n\n\n\n\n\n\n\n================================================================\n\n";	
	        cout<<"Enter 1 To View All Routes and Distances b/w Areas.\n\n";
	    	cout<<"================================================================\n\n";
			cout<<"Enter 2 For Placing Ambulance At A Source/Starting Location.\n\n"; 
			cout<<"================================================================\n\n";
			cout<<"Enter 3 To Select Priority Pateint (Assigning Destination Location).\n\n";
			cout<<"================================================================\n\n";
			cout<<"Enter 4 To View The Current Pateint And Ambulance's Location.\n\n";
			cout<<"================================================================\n\n"; 
			cout<<"Enter 5 To View The Shortest Route To The Priority Patient.\n\n";  
			cout<<"================================================================\n\n";
